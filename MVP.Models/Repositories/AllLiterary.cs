...
namespace WFViewListBooksJournals.Models.Repositories
{
    public class AllLiterary
    {
        ...
        private HashSet<Book> FillBooks()
        {
            HashSet<Book> books = new HashSet<Book>();
            books.Add(new Book { Name = "\"CLR via C#. Программирование на платформе Microsoft .NET Framework 4.5 на языке C#\"", Authors = new HashSet<Author>() { Authors["Rihter"] }, Date = new DateTime(2013, 1, 1), Pages = 896 });
            books.Add(new Book { Name = "\"Язык программирования C#5.0 и платформа .NET 4.5\"", Authors = new HashSet<Author>() { Authors["Trolsen"] }, Date = new DateTime(2015, 1, 1), Pages = 1534 });
            books.Add(new Book { Name = "\"Примеры объектно-ориентированного проектирования Паттерны проектирования\"", Authors = new HashSet<Author>() { Authors["Gamma"], Authors["Helm"], Authors["Jonson"], Authors["Vlissides"] }, Date = new DateTime(2010, 1, 1), Pages = 368 });
            books.Add(new Book { Name = "\"Design Patterns via C#. Приемы объектно - ориентированного проектирования\"", Authors = new HashSet<Author>() { Authors["ShevchukA"], Authors["Ohrimenko"], Authors["Kasyanov"] }, Date = new DateTime(2015, 1, 1), Pages = 288 });
            books.Add(new Book { Name = "\"SQL Справочник\"", Authors = new HashSet<Author>() { Authors["Klayn"], Authors["Klayna"], Authors["Hanta"] }, Date = new DateTime(2015, 10, 9), Pages = 119 });
            books.Add(new Book { Name = "\"jQuery Учебник для начинающих\"", Authors = new HashSet<Author>() { Authors["Shevchuk"] }, Date = new DateTime(2013, 1, 1), Pages = 149 });
            books.Add(new Book { Name = "\"JavaScript Подробное руководство\"", Authors = new HashSet<Author>() { Authors["Flanagun"] }, Date = new DateTime(2008, 1, 1), Pages = 982 });
            books.Add(new Book { Name = "\"JavaScript для профессиональных веб - разработчиков\"", Authors = new HashSet<Author>() { Authors["Zakas"] }, Date = new DateTime(2015, 1, 1), Pages = 960 });
            books.Add(new Book { Name = "\"HTML и CSS. Путь к совершенству.\"", Authors = new HashSet<Author>() { Authors["Henik"] }, Date = new DateTime(2011, 1, 1), Pages = 336 });
            books.Add(new Book { Name = "\"ASP.NET MVC 4 с примерами на C# 5.0 для профессионалов\"", Authors = new HashSet<Author>() { Authors["Freeman"] }, Date = new DateTime(2014, 1, 1), Pages = 666 });
            return books;
        }

        private HashSet<Journal> FillJournals()
        {
        ...
        private HashSet<Newspaper> FillNewspapers()
        {
